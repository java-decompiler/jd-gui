...
class AbstractTextPage extends JPanel implements LineNumberNavigable, ContentSearchable, UriOpenable, PreferencesChangeListener {
    ...
    protected static final ImageIcon COLLAPSED_ICON = new ImageIcon(AbstractTextPage.class.classLoader.getResource('images/plus.png'))
    protected static final ImageIcon EXPANDED_ICON = new ImageIcon(AbstractTextPage.class.classLoader.getResource('images/minus.png'))

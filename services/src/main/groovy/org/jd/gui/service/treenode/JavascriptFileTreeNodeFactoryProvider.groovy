...
class JavascriptFileTreeNodeFactoryProvider extends TextFileTreeNodeFactoryProvider {
    static final ImageIcon ICON = new ImageIcon(JavascriptFileTreeNodeFactoryProvider.class.classLoader.getResource('org/jd/gui/images/js_obj.png'))

    /**
     * @return local + optional external selectors
     */
    String[] getSelectors() { ['*:file:*.js'] + externalSelectors }
